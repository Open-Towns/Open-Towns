...
public final class UIPanel {
	...
	// BOTTOM panel
	private static ArrayList<Point> bottomPanelItemsPosition; // Array de sólo BOTTOM_PANEL_NUM_ITEMS posiciones (9) con
	...
	// BOTTOM subpanel
	private static ArrayList<Point> bottomSubPanelItemsPosition; // Array de BOTTOM_SUBPANEL_NUM_ITEMS_X x
	...
	private static int livingsGroupPanelIconsSeparation = Tile.TERRAIN_ICON_WIDTH; // Esto se cambiará seguro, no tiene
	...
	public void initialize(String sCampaignID, String sMissionID, boolean bLoadMenus) {
		...
		int spaceBetweenItems = (BOTTOM_PANEL_WIDTH - (BOTTOM_ITEM_WIDTH * BOTTOM_PANEL_NUM_ITEMS))
				/ (BOTTOM_PANEL_NUM_ITEMS + 1);
		for (int i = 0; i < BOTTOM_PANEL_NUM_ITEMS; i++) {
			bottomPanelItemsPosition
					.add(new Point(bottomPanelX + spaceBetweenItems + (i * (BOTTOM_ITEM_WIDTH + spaceBetweenItems)),
							bottomPanelY + (BOTTOM_PANEL_HEIGHT / 2) - (BOTTOM_ITEM_HEIGHT / 2)));
		}

		// Minibotón para abrir/cerrar el panel de abajo
		tileOpenCloseBottomMenuPoint.setLocation(renderWidth / 2 - tileOpenBottomMenu.getTileWidth() / 2,
		...
		infoPanelPoint.setLocation(
				renderWidth / 2 - tileInfoPanel.getTileWidth() / 2 + tileInfoPanel.getTileWidthOffset(), 0);
		...
		iconNumCitizensPoint.setLocation(iconNumCitizensBackgroundPoint.x + tileIconNumCitizens.getTileWidthOffset(),
				iconNumCitizensBackgroundPoint.y + tileIconNumCitizens.getTileHeightOffset());
		iconCitizenPreviousPoint.setLocation(
				iconNumCitizensBackgroundPoint.x + tileIconCitizenPrevious.getTileWidthOffset(),
				iconNumCitizensBackgroundPoint.y + tileIconCitizenPrevious.getTileHeightOffset());
		iconCitizenNextPoint.setLocation(iconNumCitizensBackgroundPoint.x + tileIconCitizenNext.getTileWidthOffset(),
				iconNumCitizensBackgroundPoint.y + tileIconCitizenNext.getTileHeightOffset());

		// Soldiers
		iconNumSoldiersBackgroundPoint.setLocation(infoPanelPoint.x + 2 * iSeparation + tileBottomItem.getTileWidth(),
				infoPanelPoint.y + tileIconNumSoldiers.getTileHeightOffset());
		iconNumSoldiersPoint.setLocation(iconNumSoldiersBackgroundPoint.x + tileIconNumSoldiers.getTileWidthOffset(),
				iconNumSoldiersBackgroundPoint.y + tileIconNumSoldiers.getTileHeightOffset());
		iconSoldierPreviousPoint.setLocation(
				iconNumSoldiersBackgroundPoint.x + tileIconSoldierPrevious.getTileWidthOffset(),
				iconNumSoldiersBackgroundPoint.y + tileIconSoldierPrevious.getTileHeightOffset());
		iconSoldierNextPoint.setLocation(iconNumSoldiersBackgroundPoint.x + tileIconSoldierNext.getTileWidthOffset(),
		...
		// Heroes
		iconNumHeroesBackgroundPoint.setLocation(datePanelPoint.x + tileDatePanel.getTileWidth() + iSeparation,
				infoPanelPoint.y + tileIconNumHeroes.getTileHeightOffset());
		iconNumHeroesPoint.setLocation(iconNumHeroesBackgroundPoint.x + tileIconNumHeroes.getTileWidthOffset(),
				iconNumHeroesBackgroundPoint.y + tileIconNumHeroes.getTileHeightOffset());
		iconHeroPreviousPoint.setLocation(iconNumHeroesBackgroundPoint.x + tileIconHeroPrevious.getTileWidthOffset(),
				iconNumHeroesBackgroundPoint.y + tileIconHeroPrevious.getTileHeightOffset());
		iconHeroNextPoint.setLocation(iconNumHeroesBackgroundPoint.x + tileIconHeroNext.getTileWidthOffset(),
				iconNumHeroesBackgroundPoint.y + tileIconHeroNext.getTileHeightOffset());

		// Caravan
		iconCaravanBackgroundPoint.setLocation(
				datePanelPoint.x + tileDatePanel.getTileWidth() + 2 * iSeparation + tileBottomItem.getTileWidth(),
				infoPanelPoint.y + tileIconCaravan.getTileHeightOffset());
		iconCaravanPoint.setLocation(iconCaravanBackgroundPoint.x + tileIconCaravan.getTileWidthOffset(),
		...
		iconTutorialPoint.setLocation(messageIconPoints[0].x, messageIconPoints[0].y + messageTiles[0].getTileHeight()
				+ PIXELS_TO_BORDER + BOTTOM_ITEM_HEIGHT + BOTTOM_ITEM_HEIGHT / 4);
		 ...
		 * Mini icons
		 */
		iconLevelUpPoint.setLocation(minimapPanelX + tileIconLevelUp.getTileWidthOffset(),
				minimapPanelY + tileIconLevelUp.getTileHeightOffset());
		iconLevelPoint.setLocation(minimapPanelX + tileIconLevel.getTileWidthOffset(),
				minimapPanelY + tileIconLevel.getTileHeightOffset());
		iconLevelDownPoint.setLocation(minimapPanelX + tileIconLevelDown.getTileWidthOffset(),
		...
		int iPanels = (tileDatePanel.getTileWidth() - tileIconPriorities.getTileWidth() - tileIconMats.getTileWidth())
				/ 3;
		iconMatsPoint.setLocation(datePanelPoint.x + iPanels,
				datePanelPoint.y + tileDatePanel.getTileHeight() + tileIconMats.getTileHeightOffset());
		iconPrioritiesPoint.setLocation(datePanelPoint.x + iPanels + tileIconMats.getTileWidth() + iPanels,
				datePanelPoint.y + tileDatePanel.getTileHeight() + tileIconPriorities.getTileHeightOffset());

		// Miniblocks, grid, settings, flat mouse, 3D mouse
		iconMiniblocksPoint.setLocation(minimapPanelX + tileIconMiniblocks.getTileWidthOffset(),
				minimapPanelY + tileIconMiniblocks.getTileHeightOffset());
		iconGridPoint.setLocation(minimapPanelX + tileIconGrid.getTileWidthOffset(),
				minimapPanelY + tileIconGrid.getTileHeightOffset());
		iconSettingsPoint.setLocation(minimapPanelX + tileIconSettings.getTileWidthOffset(),
				minimapPanelY + tileIconSettings.getTileHeightOffset());
		iconFlatMousePoint.setLocation(minimapPanelX + tileIconFlatMouse.getTileWidthOffset(),
				minimapPanelY + tileIconFlatMouse.getTileHeightOffset());
		icon3DMousePoint.setLocation(minimapPanelX + tileIcon3DMouse.getTileWidthOffset(),
				minimapPanelY + tileIcon3DMouse.getTileHeightOffset());

		// Lower speed, pause/resume, increase speed
		iconLowerSpeedPoint.setLocation(minimapPanelX + tileIconLowerSpeedON.getTileWidthOffset(),
				minimapPanelY + tileIconLowerSpeedON.getTileHeightOffset());
		iconPauseResumePoint.setLocation(minimapPanelX + tileIconPause.getTileWidthOffset(),
				minimapPanelY + tileIconPause.getTileHeightOffset());
		iconIncreaseSpeedPoint.setLocation(minimapPanelX + tileIconIncreaseSpeedON.getTileWidthOffset(),
	...
	public void render() {
		 ...
		 * BOTTOM menu panel
		 */
		int iCurrentTexture = tileBottomScrollLeft.getTextureID(); // Esta textura es la primera quese usa en el bottom
																	// menu
	...
	private int renderBottomMenuPanel(int mouseX, int mouseY, int mousePanel, int iCurrentTexture) {
		...
		if (mousePanel == MOUSE_BOTTOM_LEFT_SCROLL && bottomPanelItemIndex > 0) {
			UtilsGL.drawTexture(bottomPanelLeftScrollX, bottomPanelY,
					bottomPanelLeftScrollX + BOTTOM_PANEL_SCROLL_WIDTH, bottomPanelY + BOTTOM_PANEL_HEIGHT,
					tileBottomScrollLeftON.getTileSetTexX0(), tileBottomScrollLeftON.getTileSetTexY0(),
					tileBottomScrollLeftON.getTileSetTexX1(), tileBottomScrollLeftON.getTileSetTexY1());
		} else {
			UtilsGL.drawTexture(bottomPanelLeftScrollX, bottomPanelY,
					bottomPanelLeftScrollX + BOTTOM_PANEL_SCROLL_WIDTH, bottomPanelY + BOTTOM_PANEL_HEIGHT,
					tileBottomScrollLeft.getTileSetTexX0(), tileBottomScrollLeft.getTileSetTexY0(),
					tileBottomScrollLeft.getTileSetTexX1(), tileBottomScrollLeft.getTileSetTexY1());
		}

		// Right scroll
		iCurrentTexture = UtilsGL.setTexture(tileBottomScrollRight, iCurrentTexture);
		if (mousePanel == MOUSE_BOTTOM_RIGHT_SCROLL
				&& (bottomPanelItemIndex + BOTTOM_PANEL_NUM_ITEMS) < currentMenu.getItems().size()) {
			UtilsGL.drawTexture(bottomPanelRightScrollX, bottomPanelY,
					bottomPanelRightScrollX + BOTTOM_PANEL_SCROLL_WIDTH, bottomPanelY + BOTTOM_PANEL_HEIGHT,
					tileBottomScrollRightON.getTileSetTexX0(), tileBottomScrollRightON.getTileSetTexY0(),
					tileBottomScrollRightON.getTileSetTexX1(), tileBottomScrollRightON.getTileSetTexY1());
		} else {
			UtilsGL.drawTexture(bottomPanelRightScrollX, bottomPanelY,
					bottomPanelRightScrollX + BOTTOM_PANEL_SCROLL_WIDTH, bottomPanelY + BOTTOM_PANEL_HEIGHT,
					tileBottomScrollRight.getTileSetTexX0(), tileBottomScrollRight.getTileSetTexY0(),
					tileBottomScrollRight.getTileSetTexX1(), tileBottomScrollRight.getTileSetTexY1());
		}

		// Panel itself
		iCurrentTexture = UtilsGL.setTexture(tileBottomPanel, iCurrentTexture);
		UtilsGL.drawTexture(bottomPanelX, bottomPanelY, bottomPanelX + BOTTOM_PANEL_WIDTH,
				bottomPanelY + BOTTOM_PANEL_HEIGHT, tileBottomPanel.getTileSetTexX0(),
				tileBottomPanel.getTileSetTexY0(), tileBottomPanel.getTileSetTexX1(),
				tileBottomPanel.getTileSetTexY1());
			...
			if (currentMenu.getItems().get(i).getType() == SmartMenu.TYPE_MENU) {
				...
				if (checkBlinkBottom && TutorialFlow.currentBlinkBottom(currentMenu.getItems().get(i).getID())) {
					...
					drawTile(tileBottomItemSM, point, BOTTOM_ITEM_WIDTH, BOTTOM_ITEM_HEIGHT,
							(iItemBottomPanel == (i - bottomPanelItemIndex)));
					UtilsGL.unsetColor();
				} else {
					drawTile(tileBottomItemSM, point, BOTTOM_ITEM_WIDTH, BOTTOM_ITEM_HEIGHT,
							(iItemBottomPanel == (i - bottomPanelItemIndex)));
			...
			bucle1: for (int y = 0; y < BOTTOM_SUBPANEL_NUM_ITEMS_Y; y++) {
				for (int x = 0; x < BOTTOM_SUBPANEL_NUM_ITEMS_X; x++) {
					...
					if (bottomSubPanelMenu.getItems().get(iMenu).getType() == SmartMenu.TYPE_MENU) {
						iCurrentTexture = UtilsGL.setTexture(tileBottomItemSM, iCurrentTexture);
						if (checkBlinkBottom
								&& TutorialFlow.currentBlinkBottom(bottomSubPanelMenu.getItems().get(iMenu).getID())) {
							UtilsGL.setColorRed();
							drawTile(tileBottomItemSM, point, BOTTOM_ITEM_WIDTH, BOTTOM_ITEM_HEIGHT,
					...
					if (tile != null
							&& bottomSubPanelMenu.getItems().get(iMenu).getIconType() == SmartMenu.ICON_TYPE_UI) {
						iCurrentTexture = UtilsGL.setTexture(tile, iCurrentTexture);
		...
		if (bottomSubPanelMenu != null) {
			...
			bucle1: for (int y = 0; y < BOTTOM_SUBPANEL_NUM_ITEMS_Y; y++) {
				for (int x = 0; x < BOTTOM_SUBPANEL_NUM_ITEMS_X; x++) {
					...
					if (tile != null
							&& bottomSubPanelMenu.getItems().get(iMenu).getIconType() == SmartMenu.ICON_TYPE_ITEM) {
						iCurrentTexture = UtilsGL.setTexture(tile, iCurrentTexture);
						drawTile(tile, point, BOTTOM_ITEM_WIDTH, BOTTOM_ITEM_HEIGHT, (iItemBottomSubPanel == iMenu));
					}
				}
	...
	private void renderTask() {
		...
		UtilsGL.drawTexture(taskX, taskY, taskX + taskWidth + 2, taskY + taskHeight + 2,
				UIPanel.BLACK_TILE.getTileSetTexX0(), UIPanel.BLACK_TILE.getTileSetTexY0(),
				UIPanel.BLACK_TILE.getTileSetTexX1(), UIPanel.BLACK_TILE.getTileSetTexY1());
		UtilsGL.glEnd();
	...
	private void renderTooltip(int x, int y, int mousePanel) {
		...
		if (typingPanel != null) {
			...
			if (isBottomMenuPanelActive()) {
				if (mousePanel == MOUSE_BOTTOM_ITEMS) {
					...
					if (iItem != -1) {
						...
						if (item.getType() == SmartMenu.TYPE_ITEM && (iItem + bottomPanelItemIndex) >= 0
								&& (iItem + bottomPanelItemIndex) <= 9) {
						...
						if (item.getPrerequisites() != null && item.getPrerequisites().size() > 0) {
							MainPanel.renderMessages(x,
									bottomSubPanelPoint.y
											- (item.getPrerequisites().size() * (UtilFont.MAX_HEIGHT + 5)),
									renderWidth, renderHeight, Tile.TERRAIN_ICON_WIDTH / 2, item.getPrerequisites(),
			...
			if (tooltip == null && isMenuPanelActive()) {
				if (mousePanel == MOUSE_MENU_PANEL_ITEMS) {
					...
					if (iItem != -1) {
						...
						if (item.getPrerequisites() != null && item.getPrerequisites().size() > 0) {
							MainPanel.renderMessages(menuPanelPoint.x, y, renderWidth, renderHeight,
									Tile.TERRAIN_ICON_WIDTH / 2, item.getPrerequisites(), item.getPrerequisitesColor());
						} else {
							tooltip = item.getName();
							if (tooltip != null) {
								Point tooltipPoint = TooltipRenderer.leftOf(menuPanelPoint.x, y, tooltip);
			...
			if (tooltip == null && isProductionPanelActive()) {
				if (mousePanel == MOUSE_PRODUCTION_PANEL_ITEMS
					...
					if (p != null) {
						if (p.x == MOUSE_PRODUCTION_PANEL_ITEMS) {
							...
							if (item.getPrerequisites() != null && item.getPrerequisites().size() > 0) {
								if ((productionPanelPoint.x + PRODUCTION_PANEL_WIDTH) > renderWidth) {
									MainPanel.renderMessages(renderWidth, y, renderWidth, renderHeight, 0,
											item.getPrerequisites(), item.getPrerequisitesColor());
								} else {
									MainPanel.renderMessages(productionPanelPoint.x + PRODUCTION_PANEL_WIDTH, y,
											renderWidth, renderHeight, 0, item.getPrerequisites(),
											item.getPrerequisitesColor());
								}
							} else {
								tooltip = item.getName();
						...
						} else if (p.x == MOUSE_PRODUCTION_PANEL_ITEMS_MINUS_AUTOMATED
								|| p.x == MOUSE_PRODUCTION_PANEL_ITEMS_PLUS_AUTOMATED) {
							SmartMenu item = productionPanelMenu.getItems().get(p.y);
			...
			if (tooltip == null && isTradePanelActive()) {
				...
				if (!bTrading && mousePanel == MOUSE_TRADE_PANEL_BUTTONS_CARAVAN) {
					...
					if (p != null && p.x == MOUSE_TRADE_PANEL_BUTTONS_CARAVAN
							&& (p.y + tradePanel.getIndexButtonsCaravan()) < tradePanel.getMenuCaravan().getItems()
									.size()) {
						tooltip = tradePanel.getMenuCaravan().getItems().get(p.y + tradePanel.getIndexButtonsCaravan())
								.getName();
						tooltipX = x + 32;
						tooltipY = y;
					}
					...
					if (caravanData != null) {
						Point p = isMouseOnTradeButtons(x, y);
						if (p != null && p.x == MOUSE_TRADE_PANEL_BUTTONS_TO_BUY_CARAVAN
								&& (p.y + tradePanel.getIndexButtonsToBuyCaravan()) < caravanData.getMenuCaravanToBuy()
										.getItems().size()) {
							tooltip = caravanData.getMenuCaravanToBuy().getItems()
									.get(p.y + tradePanel.getIndexButtonsToBuyCaravan()).getName();
							tooltipX = x + 32;
							tooltipY = y;
						}
					}
					...
					Point p = isMouseOnTradeButtons(x, y);
					if (p != null && p.x == MOUSE_TRADE_PANEL_BUTTONS_TOWN
							&& (p.y + tradePanel.getIndexButtonsTown()) < tradePanel.getMenuTown().getItems().size()) {
						tooltip = tradePanel.getMenuTown().getItems().get(p.y + tradePanel.getIndexButtonsTown())
								.getName();
						tooltipX = x + 32;
						tooltipY = y;
					}
					...
					if (caravanData != null) {
						Point p = isMouseOnTradeButtons(x, y);
						if (p != null && p.x == MOUSE_TRADE_PANEL_BUTTONS_TO_SELL_TOWN
								&& (p.y + tradePanel.getIndexButtonsToSellTown()) < caravanData.getMenuTownToSell()
										.getItems().size()) {
							tooltip = caravanData.getMenuTownToSell().getItems()
									.get(p.y + tradePanel.getIndexButtonsToSellTown()).getName();
							tooltipX = x + 32;
							tooltipY = y;
						}
					}
			...
			if (tooltip == null && isLivingsPanelActive()) {
				if (mousePanel == MOUSE_LIVINGS_PANEL_BUTTONS_CLOSE) {
					...
					tooltipX = x - (UtilFont.getWidth(tooltip) / 2);
					tooltipY = livingsPanelIconRestrictUpPoint.y + tileIconLevelUp.getTileHeight();
				} else if (mousePanel == MOUSE_LIVINGS_PANEL_BUTTONS_ROWS_PROFESSIONS
						&& livingsPanelCitizensGroupActive == -1) {
			...
			if (tooltip == null) {
				if (mousePanel == MOUSE_DATEPANEL) {
					...
					tooltipX = iconLevelUpPoint.x + tileIconLevelUp.getTileWidth() / 2
					...
					tooltipX = iconLevelDownPoint.x + tileIconLevelDown.getTileWidth() / 2
							- (UtilFont.getWidth(tooltip) / 2);
					...
					tooltipX = iconCitizenPreviousPoint.x + tileIconCitizenPrevious.getTileWidth() / 2
							- (UtilFont.getWidth(tooltip) / 2);
					...
					tooltipX = iconCitizenNextPoint.x + tileIconCitizenNext.getTileWidth() / 2
							- (UtilFont.getWidth(tooltip) / 2);
					...
					tooltipX = iconSoldierPreviousPoint.x + tileIconSoldierPrevious.getTileWidth() / 2
							- (UtilFont.getWidth(tooltip) / 2);
					...
					tooltipX = iconSoldierNextPoint.x + tileIconSoldierNext.getTileWidth() / 2
							- (UtilFont.getWidth(tooltip) / 2);
					...
					tooltipX = iconHeroPreviousPoint.x + tileIconHeroPrevious.getTileWidth() / 2
							- (UtilFont.getWidth(tooltip) / 2);
					...
					tooltipX = iconHeroNextPoint.x + tileIconHeroNext.getTileWidth() / 2
							- (UtilFont.getWidth(tooltip) / 2);
					...
					tooltip = Messages.getString("UIPanel.8") + " (" + Messages.getString("UIPanel.76") + ": " //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
							...
							+ ")"; //$NON-NLS-1$
					tooltipX = iconNumCitizensBackgroundPoint.x + tileBottomItem.getTileWidth() / 2
							- (UtilFont.getWidth(tooltip) / 2);
					...
					tooltipX = iconNumSoldiersBackgroundPoint.x + tileBottomItem.getTileWidth() / 2
							- (UtilFont.getWidth(tooltip) / 2);
					...
					tooltipX = iconNumHeroesBackgroundPoint.x + tileBottomItem.getTileWidth() / 2
							- (UtilFont.getWidth(tooltip) / 2);
					...
					tooltipX = iconCaravanBackgroundPoint.x + tileBottomItem.getTileWidth() / 2
							- (UtilFont.getWidth(tooltip) / 2);
					...
					tooltipX = iconPrioritiesPoint.x + tileIconPriorities.getTileWidth() / 2
							- (UtilFont.getWidth(tooltip) / 2);
					...
					tooltipX = iconMiniblocksPoint.x + tileIconMiniblocks.getTileWidth() / 2
							- (UtilFont.getWidth(tooltip) / 2);
					...
					tooltipX = iconFlatMousePoint.x + tileIconFlatMouse.getTileWidth() / 2
							- (UtilFont.getWidth(tooltip) / 2);
					...
					tooltipX = icon3DMousePoint.x + tileIcon3DMouse.getTileWidth() / 2
							- (UtilFont.getWidth(tooltip) / 2);
					...
					tooltipX = iconPauseResumePoint.x + tileIconPause.getTileWidth() / 2
							- (UtilFont.getWidth(tooltip) / 2);
					...
					tooltipX = iconSettingsPoint.x + tileIconSettings.getTileWidth() / 2
							- (UtilFont.getWidth(tooltip) / 2);
					...
					tooltipX = iconLowerSpeedPoint.x + tileIconLowerSpeed.getTileWidth() / 2
							- (UtilFont.getWidth(tooltip) / 2);
					...
					tooltipX = iconIncreaseSpeedPoint.x + tileIconIncreaseSpeed.getTileWidth() / 2
							- (UtilFont.getWidth(tooltip) / 2);
		...
		if (tooltip != null) {
			TooltipRenderer.draw(tooltip, tooltipX, tooltipY, renderWidth, renderHeight);
		}
				...
				if (alEvents.size() == 0) {
					...
					UtilsGL.drawTooltip(tooltip,
							iconEventsPoint.x + GlobalEventData.getIcon().getTileWidth() / 2
									- UtilFont.getWidth(tooltip) / 2,
							iconEventsPoint.y + GlobalEventData.getIcon().getTileHeight(), renderWidth, renderHeight);
				} else {
	...
	private static void closePanels(boolean bPriorities, boolean bTrade, boolean bMessages, boolean bMats,
