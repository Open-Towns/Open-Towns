...
public final class MainMenuPanel implements Runnable {
    ...
    public void createMenu() {
        ...
        // // Tutorial
        // SmartMenu menuTutorial = new SmartMenu(SmartMenu.TYPE_MENU,
        // Messages.getString("MainMenuPanel.82"), //$NON-NLS-1$
        ...
        // new SmartMenu(SmartMenu.TYPE_TEXT, Messages.getString("MainMenuPanel.82"),
        // null, null, null, null)); //$NON-NLS-1$
        // menuTutorial.addItem(new SmartMenu(SmartMenu.TYPE_TEXT, null, null, null,
        // null, null));

        // // New game
        // SmartMenu menuCampaign = new SmartMenu(SmartMenu.TYPE_MENU,
        // Messages.getString("MainMenuPanel.53"), //$NON-NLS-1$
        // mainMenu, null, null, null, null, textColor);
        // menuCampaign.setTrasparency(mainMenu.isTrasparency());
        // menuCampaign.setBorderColor(borderColor);
        // menuCampaign.addItem(
        // new SmartMenu(SmartMenu.TYPE_TEXT, Messages.getString("MainMenuPanel.53"),
        // null, null, null, null)); //$NON-NLS-1$
        ...
        // // campaign.addItem(new SmartMenu(SmartMenu.TYPE_TEXT, null, null, null,
        // null,
        // // null));
        ...
        // if (Game.isAllowBury() &&
        // alCampaigns.get(i).getMissions().get(j).isAllowBury()) {
        // SmartMenu loadBurieds = new SmartMenu(SmartMenu.TYPE_MENU, missionName,
        // campaign, null, null,
        // null, null, textColor);
        // loadBurieds.setTrasparency(true);
        // loadBurieds.setBorderColor(borderColor);

        // loadBurieds.addItem(new SmartMenu(SmartMenu.TYPE_TEXT, missionName, null,
        // null, null, null));
        // loadBurieds.addItem(new SmartMenu(SmartMenu.TYPE_TEXT, null, null, null,
        // null, null));

        // // No bury
        // menuAux = new SmartMenu(SmartMenu.TYPE_ITEM,
        // Messages.getString("MainMenuPanel.69"), null, //$NON-NLS-1$
        // CommandPanel.COMMAND_MM_NEWGAME_SET_SAVE_NAME_NO_BURY, sCampaignID,
        // sMissionID, null,
        // textColor);
        ...
        // // Local bury
        // menuAux = new SmartMenu(SmartMenu.TYPE_ITEM,
        // Messages.getString("MainMenuPanel.67"), null, //$NON-NLS-1$
        ...
        // menuAux = new SmartMenu(SmartMenu.TYPE_ITEM,
        // Messages.getString("MainMenuPanel.68") + " [" + Game.getServerNames().get(s)
        // //$NON-NLS-1$ //$NON-NLS-2$
        // + "]", //$NON-NLS-1$
        ...
        // }
        // }
        // loadBurieds.addItem(new SmartMenu(SmartMenu.TYPE_ITEM,
        // Messages.getString("MainMenuPanel.7"), //$NON-NLS-1$
        ...
        // menuAux = new SmartMenu(SmartMenu.TYPE_ITEM,
        // Messages.getString("MainMenuPanel.7"), null, //$NON-NLS-1$
        ...
        // // // Back New game
        // // menuAux = new SmartMenu(SmartMenu.TYPE_ITEM,
        // // Messages.getString("MainMenuPanel.7"), null, CommandPanel.COMMAND_BACK,
        // null,
        ...
        // SmartMenu menuLoad = new SmartMenu(SmartMenu.TYPE_MENU,
        // Messages.getString("MainMenuPanel.38"), mainMenu, //$NON-NLS-1$
        // null, null, null, null, textColor);
        // menuLoad.setTrasparency(mainMenu.isTrasparency());
        // menuLoad.setBorderColor(borderColor);

        // menuLoad.addItem(
        // new SmartMenu(SmartMenu.TYPE_TEXT, Messages.getString("MainMenuPanel.38"),
        ...
        // sDate = " (" + Messages.getString("MainMenuPanel.42"); //$NON-NLS-1$
        // //$NON-NLS-2$
        // } else if ((cal.get(Calendar.DAY_OF_MONTH) + 1) ==
        // calToday.get(Calendar.DAY_OF_MONTH)
        // && cal.get(Calendar.MONTH) == calToday.get(Calendar.MONTH)
        // && cal.get(Calendar.YEAR) == calToday.get(Calendar.YEAR)) {
        // sDate = " (" + Messages.getString("MainMenuPanel.51"); //$NON-NLS-1$
        // //$NON-NLS-2$
        // } else {
        // sDate = " (" + cal.get(Calendar.DAY_OF_MONTH) + "/" //$NON-NLS-1$
        // //$NON-NLS-2$
        // + (((cal.get(Calendar.MONTH) + 1) < 10) ? "0" : "") +
        // (cal.get(Calendar.MONTH) + 1) + "/" //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
        // + cal.get(Calendar.YEAR);
        // }
        // sDate += " " + ((cal.get(Calendar.HOUR_OF_DAY) < 10) ? "0" : "") +
        // cal.get(Calendar.HOUR_OF_DAY) + ":" //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
        // //$NON-NLS-4$
        ...
        // Messages.getString("MainMenuPanel.40") +
        // Utils.removeExtension(fAux.getName()) + sDate, null, //$NON-NLS-1$
        // CommandPanel.COMMAND_MM_CONTINUEGAME, fAux.getName(), null, null,
        // textColor));
        // // Delete game (con su submenú de confirmación)
        // SmartMenu menuDelete = new SmartMenu(SmartMenu.TYPE_MENU,
        // Messages.getString("MainMenuPanel.49") +
        // Utils.removeExtension(fAux.getName()) + sDate, //$NON-NLS-1$
        ...
        // Utils.removeExtension(fAux.getName()) + sDate, null, //$NON-NLS-1$
        // null, null));
        // menuDelete.addItem(new SmartMenu(SmartMenu.TYPE_TEXT, null, null, null,
        // null));
        // menuDelete.addItem(new SmartMenu(SmartMenu.TYPE_TEXT,
        // Messages.getString("MainMenuPanel.54"), null, //$NON-NLS-1$
        // null, null, null, null, Color.RED));
        // menuDelete.addItem(new SmartMenu(SmartMenu.TYPE_ITEM,
        // Messages.getString("MainMenuPanel.55") +
        // Utils.removeExtension(fAux.getName()) + sDate, null, //$NON-NLS-1$
        ...
        // // Mods
        // SmartMenu smMods = new SmartMenu(SmartMenu.TYPE_MENU,
        // Messages.getString("MainMenuPanel.58"), mainMenu, null, //$NON-NLS-1$
        // null, null, null, textColor);
        // smMods.setTrasparency(mainMenu.isTrasparency());
        // smMods.setBorderColor(borderColor);
        // smMods.addItem(
        // new SmartMenu(SmartMenu.TYPE_TEXT, Messages.getString("MainMenuPanel.58"),
        // null, null, null, null)); //$NON-NLS-1$
        // smMods.addItem(new SmartMenu(SmartMenu.TYPE_TEXT, null, null, null, null,
        // null));
        // String sModsFolder = Game.getUserFolder() + Game.getFileSeparator() +
        // Game.MODS_FOLDER1
        // + Game.getFileSeparator();
        // smMods.addItem(
        // new SmartMenu(SmartMenu.TYPE_ITEM, Messages.getString("MainMenuPanel.70") + "
        // [" + sModsFolder + "]", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
        ...
        // menuAux = new SmartMenu(SmartMenu.TYPE_ITEM,
        // alMods.get(i).getName() + " __MOD__" + alMods.get(i).getName() + "__/MOD__",
        ...
        // // No mods
        // smMods.addItem(
        // new SmartMenu(SmartMenu.TYPE_TEXT, Messages.getString("MainMenuPanel.60"),
        // null, null, null, null)); //$NON-NLS-1$
        // }
        ...
        // // Servers
        // SmartMenu smServers = new SmartMenu(SmartMenu.TYPE_MENU,
        // Messages.getString("MainMenuPanel.71"), mainMenu, null, //$NON-NLS-1$
        // null, null, null, textColor);
        // smServers.setTrasparency(mainMenu.isTrasparency());
        // smServers.setBorderColor(borderColor);
        // smServers.addItem(
        // new SmartMenu(SmartMenu.TYPE_TEXT, Messages.getString("MainMenuPanel.71"),
        // null, null, null, null)); //$NON-NLS-1$
        ...
        // menuAux = new SmartMenu(SmartMenu.TYPE_TEXT, sServer, null, null, null, null,
        // null, Color.YELLOW);
        // menuAux.setDynamic(true);
        // menuAux.setBorderColor(borderColor);
        // smServers.addItem(menuAux);
        // smServers.addItem(new SmartMenu(SmartMenu.TYPE_ITEM,
        // Messages.getString("MainMenuPanel.73") + sServer, //$NON-NLS-1$
        // null, CommandPanel.COMMAND_SERVER_REMOVE, Game.getServers().get(i)));
        // smServers.addItem(new SmartMenu(SmartMenu.TYPE_TEXT, null, null, null,
        // null));
        // }
        // } else {
        // // No servers
        // smServers.addItem(
        // new SmartMenu(SmartMenu.TYPE_TEXT, Messages.getString("MainMenuPanel.74"),
        // null, null, null, null)); //$NON-NLS-1$
        // smServers.addItem(new SmartMenu(SmartMenu.TYPE_TEXT, null, null, null,
        // null));
        // }
        ...
        // smServers.addItem(new SmartMenu(SmartMenu.TYPE_ITEM,
        // Messages.getString("MainMenuPanel.75"), null, //$NON-NLS-1$
        ...
        // SmartMenu menuOptions = MainMenuOptions.createMenu( mainMenu);
        ...
        // // Credits
        // SmartMenu smCredits = new SmartMenu(SmartMenu.TYPE_MENU,
        // Messages.getString("MainMenuPanel.34"), mainMenu, null, //$NON-NLS-1$
        // null, null, null, textColor);
        // smCredits.setTrasparency(mainMenu.isTrasparency());
        // smCredits.setBorderColor(borderColor);
        // smCredits.addItem(
        // new SmartMenu(SmartMenu.TYPE_TEXT, Messages.getString("MainMenuPanel.34"),
        // null, null, null, null)); //$NON-NLS-1$
        // smCredits.addItem(new SmartMenu(SmartMenu.TYPE_TEXT, null, null, null, null,
        // null));

        // menuAux = new SmartMenu(SmartMenu.TYPE_TEXT,
        // Messages.getString("MainMenuPanel.35"), null, null, null, null, //$NON-NLS-1$
        // null, creditsColor);
        // menuAux.setDynamic(true);
        // menuAux.setBorderColor(borderColor);
        // smCredits.addItem(menuAux);
        // menuAux = new SmartMenu(SmartMenu.TYPE_TEXT, "Xavi 'supermalparit' Canal",
        // null, null, null, null, null, //$NON-NLS-1$
        // textColor);
        // menuAux.setDynamic(true);
        // menuAux.setBorderColor(borderColor);
        // smCredits.addItem(menuAux);
        // smCredits.addItem(new SmartMenu(SmartMenu.TYPE_TEXT, null, null, null,
        // null));

        // menuAux = new SmartMenu(SmartMenu.TYPE_TEXT,
        // Messages.getString("MainMenuPanel.37"), null, null, null, null, //$NON-NLS-1$
        // null, creditsColor);
        // menuAux.setDynamic(true);
        // menuAux.setBorderColor(borderColor);
        // smCredits.addItem(menuAux);
        // menuAux = new SmartMenu(SmartMenu.TYPE_TEXT, "Ben 'burningpet' Palgi", null,
        // null, null, null, null, textColor); //$NON-NLS-1$
        // menuAux.setDynamic(true);
        // menuAux.setBorderColor(borderColor);
        // smCredits.addItem(menuAux);
        // smCredits.addItem(new SmartMenu(SmartMenu.TYPE_TEXT, null, null, null,
        ...
        // menuAux = new SmartMenu(SmartMenu.TYPE_TEXT,
        // Messages.getString("MainMenuPanel.39"), null, null, null, null, //$NON-NLS-1$
        // null, creditsColor);
        // menuAux.setDynamic(true);
        // menuAux.setBorderColor(borderColor);
        // smCredits.addItem(menuAux);
        // menuAux = new SmartMenu(SmartMenu.TYPE_TEXT, "Sam 'Evilpooley' Poole", null,
        // null, null, null, null, textColor); //$NON-NLS-1$
        // menuAux.setDynamic(true);
        // menuAux.setBorderColor(borderColor);
        // smCredits.addItem(menuAux);
        ...
        // menuAux = new SmartMenu(SmartMenu.TYPE_TEXT,
        // Messages.getString("MainMenuPanel.78"), null, null, null, null, //$NON-NLS-1$
        // null, creditsColor);
        // menuAux.setDynamic(true);
        // menuAux.setBorderColor(borderColor);
        // smCredits.addItem(menuAux);
        // menuAux = new SmartMenu(SmartMenu.TYPE_TEXT, "Florian 'Moebius'
        // Frankenberger", null, null, null, null, null, //$NON-NLS-1$
        // textColor);
        // menuAux.setDynamic(true);
        // menuAux.setBorderColor(borderColor);
        // smCredits.addItem(menuAux);
        ...
        // // Exit
        // menuAux = new SmartMenu(SmartMenu.TYPE_ITEM,
        // Messages.getString("MainMenuPanel.3"), null, //$NON-NLS-1$
